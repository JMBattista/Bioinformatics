...
public final class AcceptUnknownDnaEncodingScheme implements EncodingScheme {
    ...
    static final byte NUCLEOTIDE_Y =  NUCLEOTIDE_C | NUCLEOTIDE_T | NUCLEOTIDE_U;
    static final byte NUCLEOTIDE_K =  NUCLEOTIDE_G | NUCLEOTIDE_T | NUCLEOTIDE_U;
    ...
    static final byte NUCLEOTIDE_B =  NUCLEOTIDE_C | NUCLEOTIDE_G | NUCLEOTIDE_T | NUCLEOTIDE_U;
    static final byte NUCLEOTIDE_D =  NUCLEOTIDE_A | NUCLEOTIDE_G | NUCLEOTIDE_T | NUCLEOTIDE_U;
    static final byte NUCLEOTIDE_H =  NUCLEOTIDE_A | NUCLEOTIDE_C | NUCLEOTIDE_T | NUCLEOTIDE_U;
    static final byte NUCLEOTIDE_V =  NUCLEOTIDE_A | NUCLEOTIDE_C | NUCLEOTIDE_G;
    static final byte NUCLEOTIDE_N =  NUCLEOTIDE_A | NUCLEOTIDE_C | NUCLEOTIDE_G | NUCLEOTIDE_T | NUCLEOTIDE_U;
    static final byte NUCLEOTIDE_X =  0b1_00_00_00;
    static final byte NUCLEOTIDE_GAP = 0b0_00_00_00;
